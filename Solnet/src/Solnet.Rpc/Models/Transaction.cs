...
namespace Solnet.Rpc.Models
{
    ...
    public class Transaction
    {
        ...
        /// <summary>
        /// The account keys in the transaction message, in the correct order.
        /// </summary>
        internal IList<PublicKey> _accountKeys;

        /// <summary>
        /// Gets the account keys from the transaction message.
        /// </summary>
        public IReadOnlyList<PublicKey> AccountKeys => _accountKeys?.ToList()?.AsReadOnly();
        /// <summary>
