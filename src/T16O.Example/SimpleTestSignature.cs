...
/// <summary>
/// Simple test to fetch a single transaction by signature
/// </summary>
public class SimpleTestSignature
{
    public static async Task Run()
    {
        Console.WriteLine("=== Simple Signature Transaction Test ===\n");
        ...
        // Test with a hardcoded signature
        var testSignature = "1HFuLeJDUeJHXNXCehACgHswcK4Fxzt4DBcGyCSvzf4BnZKvEiKq8VqUrARimDRY5RteQzxRm7Qr57D6G4aHH1V";

        try
        {
            Console.WriteLine($"Fetching transaction for signature: {testSignature}\n");
