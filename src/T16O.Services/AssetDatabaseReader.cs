...
internal class AssetDatabaseReader
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await using var command = new MySqlCommand(
            "SELECT asset_json FROM solana_events.asset WHERE mint_address = @p_mint_address",
            connection);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await using var command = new MySqlCommand("solana_events.usp_mint_getUnknown", connection)
        {
    ...
    /// <summary>
    /// Get the symbol for an asset from the database (uses usp_asset_get)
    /// </summary>
    /// <param name="mintAddress">Mint address</param>
    /// <param name="cancellationToken">Cancellation token</param>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await using var command = new MySqlCommand("usp_asset_get", connection)
        {
            CommandType = System.Data.CommandType.StoredProcedure
        };
        command.Parameters.AddWithValue("p_mint_address", mintAddress);
    ...
    /// Calls usp_asset_get(null) which returns all assets.
    /// </summary>
    /// <param name="cancellationToken">Cancellation token</param>
