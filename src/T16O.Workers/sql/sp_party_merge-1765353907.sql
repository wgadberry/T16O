...
proc_body: BEGIN
    ...
    SET tb.action_type = CASE
        ...
        -- ============================================================
        -- Winston Worker Additions (2025-12-10 08:05:07 UTC)
        -- ============================================================
        ...
        -- CreateTokenAccount instruction (6 occurrences)
        WHEN v_log_messages LIKE '%Instruction: CreateTokenAccount%'
        THEN 'createAccount'

        -- Swap2 instruction (6 occurrences)
        ...
        -- WithdrawFromAccounts instruction (2 occurrences)
        WHEN v_log_messages LIKE '%Instruction: WithdrawFromAccounts%'
        THEN 'withdraw'
