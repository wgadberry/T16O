...
-- Generated: 2025-12-10 09:14:28 UTC
-- Added 5 new action type conditions
...
proc_body: BEGIN
    ...
    SET tb.action_type = CASE
        ...
        -- ============================================================
        -- Winston Worker Additions (2025-12-10 09:14:28 UTC)
        -- ============================================================
        ...
        -- CreateTokenAccount instruction (1 occurrences)
        WHEN v_log_messages LIKE '%Instruction: CreateTokenAccount%'
        THEN 'createAccount'

        -- Swap2 instruction (1 occurrences)
