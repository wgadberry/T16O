...
-- Generated: 2025-12-11 02:25:46 UTC
...
proc_body: BEGIN
    ...
    SET tb.action_type = CASE
        ...
        -- ============================================================
        -- Winston Worker Additions (2025-12-11 02:25:46 UTC)
        -- ============================================================
        ...
        -- CreateTokenAccount instruction (84 occurrences)
        ...
        -- WithdrawWithheldTokensFromMint instruction (5 occurrences)
        WHEN v_log_messages LIKE '%Instruction: WithdrawWithheldTokensFromMint%'
        THEN 'withdraw'

        -- WithdrawWithheldTokensFromAccounts instruction (4 occurrences)
