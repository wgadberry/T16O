...
-- Generated: 2025-12-10 07:27:45 UTC
-- Added 9 new action type conditions
...
proc_body: BEGIN
    ...
    SET tb.action_type = CASE
        ...
        -- ============================================================
        -- Winston Worker Additions (2025-12-10 07:27:45 UTC)
        -- ============================================================
        ...
        -- CreateTokenAccount instruction (5 occurrences)
        WHEN v_log_messages LIKE '%Instruction: CreateTokenAccount%'
        THEN 'createAccount'

        -- WithdrawWithheldTokensFromMint instruction (2 occurrences)
        WHEN v_log_messages LIKE '%Instruction: WithdrawWithheldTokensFromMint%'
        THEN 'withdraw'

        -- RaydiumCpmmSwapCpiVision instruction (1 occurrences)
        WHEN v_log_messages LIKE '%Instruction: RaydiumCpmmSwapCpiVision%'
        THEN 'swap'
