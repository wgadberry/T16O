...
-- Generated: 2025-12-10 11:40:32 UTC
...
proc_body: BEGIN
    ...
    SET tb.action_type = CASE
        ...
        -- ============================================================
        -- Winston Worker Additions (2025-12-10 11:40:32 UTC)
        -- ============================================================
        ...
        -- CreateTokenAccount instruction (83 occurrences)
        ...
        -- Swap2 instruction (25 occurrences)
        WHEN v_log_messages LIKE '%Instruction: Swap2%'
        THEN 'swap'

        -- SwapBaseInput instruction (18 occurrences)
        ...
        -- WithdrawWithheldTokensFromMint instruction (3 occurrences)
        ...
        -- CreatePool instruction (1 occurrences)
        WHEN v_log_messages LIKE '%Instruction: CreatePool%'
        THEN 'createAccount'
