...
-- Generated: 2025-12-10 08:11:05 UTC
-- Added 10 new action type conditions
-- New ENUM values required: sync, withdraw
-- ============================================================
--
...
proc_body: BEGIN
    ...
    SET tb.action_type = CASE
        ...
        -- ============================================================
        -- Winston Worker Additions (2025-12-10 08:11:05 UTC)
        -- ============================================================

        -- TransferFee instruction (24 occurrences)
        WHEN v_log_messages LIKE '%Instruction: TransferFee%'
        THEN 'transfer'

        -- CreateTokenAccount instruction (18 occurrences)
        WHEN v_log_messages LIKE '%Instruction: CreateTokenAccount%'
        THEN 'createAccount'

        -- Swap2 instruction (17 occurrences)
        ...
        -- WithdrawWithheldTokensFromAccounts instruction (3 occurrences)
        WHEN v_log_messages LIKE '%Instruction: WithdrawWithheldTokensFromAccounts%'
        THEN 'withdraw'

        -- SwapBaseInput instruction (2 occurrences)
        ...
        -- CreateLockEscrow instruction (1 occurrences)
        WHEN v_log_messages LIKE '%Instruction: CreateLockEscrow%'
        THEN 'createAccount'
