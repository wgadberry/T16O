...
--
-- Usage:
--   CALL sp_detect_chart_clipping('SOLTIT', 5.0, 300);
--   -- Finds buys >= 5 SOL with sells within 5 minutes
--
-- Output:
--   1. Episode summary (grouped activity windows)
--   2. Detailed transaction list with episode_id
...
CREATE PROCEDURE sp_detect_chart_clipping(
