#!/usr/bin/env python3
"""
Price Loader - Load historical token prices from Solscan API into tx_token_price

Queries tx_guide for distinct tokens by day, then fetches prices from Solscan
and stores them in tx_token_price table.

Usage:
    python price-loader.py                     # Process all days
    python price-loader.py --days 7            # Process last 7 days only
    python price-loader.py --date 20251210     # Process specific date
    python price-loader.py --skip-existing     # Skip tokens that already have prices
"""
