#!/usr/bin/env python3
"""
Pool Enricher - Fetch pool details from Solscan and link to programs

Uses /market/info endpoint to look up individual pools missing program linkage.

Usage:
    python pool-enricher.py [--max-pools 100]
    python pool-enricher.py --dry-run
    python pool-enricher.py --sample <pool_address>
"""
