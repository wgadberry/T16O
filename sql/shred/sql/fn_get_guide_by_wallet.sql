-- fn_get_guide_by_wallet: Get tx_guide edges for a wallet address
-- Returns JSON array of edges where wallet is from_address or to_address
--
-- Parameters:
--   p_wallet_address: Wallet address to search
