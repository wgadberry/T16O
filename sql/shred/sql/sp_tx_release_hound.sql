...
--
-- Uses batched processing to avoid blocking other traffic.
-- Commits after each batch to release locks.
--
-- Usage:
--   CALL sp_tx_release_hound(NULL, NULL, NULL);     -- Process all untracked (default batch 1000)
--   CALL sp_tx_release_hound(12345, NULL, NULL);    -- Process specific tx_id
--   CALL sp_tx_release_hound(NULL, 10000, NULL);    -- Process max 10000 total
--   CALL sp_tx_release_hound(NULL, NULL, 500);      -- Process in batches of 500
--
-- Direction Logic:
--   SWAP:  wallet_1 (owner_1) sends token_1, receives token_2 -> BOTH
