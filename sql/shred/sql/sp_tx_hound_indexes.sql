-- ============================================================
-- sp_tx_hound_indexes
-- Manage indexes on tx_hound for bulk loading
--
-- Usage:
--   CALL sp_tx_hound_indexes('drop');    -- Drop non-PK indexes before bulk load
--   CALL sp_tx_hound_indexes('create');  -- Recreate indexes after bulk load
--   CALL sp_tx_hound_indexes('status');  -- Show current index count
--
-- Workflow for large loads:
--   CALL sp_tx_hound_indexes('drop');
--   CALL sp_tx_release_hound(NULL, NULL, 5000);
--   CALL sp_tx_hound_indexes('create');
-- ============================================================
...
CREATE PROCEDURE sp_tx_hound_indexes(
