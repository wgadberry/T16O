#!/usr/bin/env python3
"""
Guide Load Programs - Load known program addresses into tx_program

Ensures all programs from programs.json exist in the database with proper labels.
Enriches tx_program table.

Usage:
    python guide-load-programs.py [--json-file path/to/programs.json]
