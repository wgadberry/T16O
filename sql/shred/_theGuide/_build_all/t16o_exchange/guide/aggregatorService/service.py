...
class AggregatorService(GuideServiceBase):
    ...
    _svc_name_ = 'T16OExchange.Guide.Aggregator'
    _svc_display_name_ = 'T16O Exchange - Guide Aggregator'
    _svc_description_ = 'T16O Exchange Guide Aggregator Service - Aggregates transaction and address data'
