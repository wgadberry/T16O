...
CREATE TABLE `tx_guide` (
  ...
  `from_token_pre_balance` bigint DEFAULT NULL COMMENT 'Source token balance before tx',
  `from_token_post_balance` bigint DEFAULT NULL COMMENT 'Source token balance after tx',
  `to_token_pre_balance` bigint DEFAULT NULL COMMENT 'Dest token balance before tx',
  `to_token_post_balance` bigint DEFAULT NULL COMMENT 'Dest token balance after tx',
  `from_sol_pre_balance` bigint DEFAULT NULL COMMENT 'Source SOL balance before tx',
  `from_sol_post_balance` bigint DEFAULT NULL COMMENT 'Source SOL balance after tx',
  `to_sol_pre_balance` bigint DEFAULT NULL COMMENT 'Dest SOL balance before tx',
  `to_sol_post_balance` bigint DEFAULT NULL COMMENT 'Dest SOL balance after tx',
