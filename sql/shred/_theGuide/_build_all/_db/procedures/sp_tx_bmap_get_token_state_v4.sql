-- sp_tx_bmap_get_token_state_v4: Time-navigable cluster map for token (V2)
...
--
-- Usage:
--   CALL sp_tx_bmap_get_token_state_v4(NULL, 'BONK', NULL, NULL, NULL, NULL);
--   CALL sp_tx_bmap_get_token_state_v4(NULL, NULL, 'DezXAZ...', '5KtP...abc', NULL, NULL);
--   CALL sp_tx_bmap_get_token_state_v4(NULL, NULL, NULL, '5KtP...abc', NULL, NULL);  -- derive token from sig
--   CALL sp_tx_bmap_get_token_state_v4(NULL, 'BONK', NULL, NULL, 1703000000, 20);  -- 20 tx window

DROP PROCEDURE IF EXISTS sp_tx_bmap_get_token_state_v4;

DELIMITER //

CREATE PROCEDURE sp_tx_bmap_get_token_state_v4(
