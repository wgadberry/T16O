...
class GuideShredder:
    ...
    def __init__(self, cursor, conn):
        ...
        # Track type_state per tx_id (accumulated indicators)
    ...
    def _load_edge_types(self):
        """Load tx_guide_type into cache (id and indicator)"""
    ...
    def get_edge_indicator(self, type_code: str) -> int:
        """Get edge type indicator from cache, default to 'unknown' indicator"""
    ...
    def add_edge(self, tx_id: int, block_time: int,
        ...
        """Add edge to buffer and accumulate type_state"""
        ...
        # Accumulate type_state (OR the indicator)
    ...
    def flush_edges(self) -> int:
        """Bulk insert edges to tx_guide and update tx.type_state"""
        ...
        # Update tx.type_state with accumulated indicators (OR with existing)
